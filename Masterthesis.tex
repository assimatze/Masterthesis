...
\\\\
Die Informationen die in einer Dokumentation hinterlegt werden, können nach verschiedenen Kriterien kategorisiert werden. So können Informationen nach Ihren Typ und deren Personengruppe kategorisiert werden.\cite{technicalDebt} 
\newpage
\listoftables
\listoffigures
\newpage
