...
\end{figure}
\\
Der zweite zu betrachtende Sonderfall wäre der, dass die aufgeführten Leser wieder deselektiert werden müssen, falls sich der Inhalt durch das editieren des Supporters oder des Autors geändert hat. Hierfür sollen die Player die in der Viewer-Anzeiger aufgeführt sind einfach grau unterlegt werden. Des Weiteren sollen die Leser bei Änderungen informiert werden wenn sie dies vorher eingestellt haben.   
