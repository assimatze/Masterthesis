...
\\\\
Darüber hinaus sind Spiele kein Zwang, sie sind freiwillig. Unser Wille sich dem Spiel und seinen Regeln zu beugen steht im Zentrum. Man kann die herausfordernden Aufgaben eines Spiels annehmen, man muss aber nicht \cite{Rigby2011}. Dadurch zeigt sich die Selbstbestimmung am ehesten. 
\\\\
...
\\\\
Studien zeigen das extrinsische Belohnungen bei Kreativen-Tätigkeiten eher kontraproduktiv sind und nicht zu einer Leistungssteigerung führen \cite{Pink2010}. Verspricht man aber Leuten die einer Akkord ähnlichen Arbeit nachgehen eine extrinsische Belohnung, so werden diese Leute produktiver und somit leistungsfähiger. Deswegen vermutet man, das extrinsische Belohnungen dazu führen, dass der Fokus nun auf die Belohnung gelenkt wird, was Ablenkungen und kreative Ansätze mindert. Dadurch werden also Tätigkeiten denen z.B kein kreativer Lösungsansatz voraus geht für Menschen motivierender. Menschen mindern aber durch den Fokus auf die Belohnung ihre Vorstellungskraft und Kreativität, was dazu führt, dass die Produktivität dieser Tätigkeiten nicht erhöht sondern stattdessen vermindert wird.
