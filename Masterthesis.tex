...
In diesem Kapitel haben wir uns mit den Grundlagen der Gamification auseinander gesetzt. Zunächst wurde beschrieben, in welchen Zusammenhang Games und die Gamification stehen. Durch die Unterschiede wie z.B. die Zweckmäßigkeit der Gamification oder das Fehlen von Gameplay ist zu erkennen, dass die Gamification anders einzuordnen ist wie herkömmliche Games. Jedoch sind die Übergänge zwischen Games und Gamification fließend weshalb es möglich ist, die verschiedenen Prinzipien und Verfahren die aus der Spieleentwicklung bekannt sind auch für die Gamification einzusetzen.
\\\\
Beim Design wurde auch zwischen Gameful-Design und Playful-Design unterschieden. Wobei die Unterscheidung beim Design daher kommt, dass Gameful-Design sich auf die Funktionsweise einer Anwendung auswirkt was bei Playful-Design nicht der Fall ist. 
\\\\
Die aus dem Game-Design (Spieleentwicklung) bekannten Elemente wie Game-Mechaniken oder Game-Design Grundsätzen wurden ebenfalls aufgeführt und deren beschreibung in fünf Abstraktionsebenen eingeteilt. Durch die Abstraktionsebenen ist ein Strukturierter Abhängigkeit der verschiedenen Game-Design Elemente dargestellt worden. So sind die Oberen Ebenen wichtig für den Anwender und die unteren Ebenen eher für den Entwickler wichtig.
\\\\
Auf die Abstraktionsebenen wurde im weiteren verlauf dieses Kapitel einzeln eingegangen um ein besseres Verständniss über den Game-Design Prozess zu erhalten. Zuerst wurde klar das Jedes Spiel und auch jede Gamifiaction Anwendung sich auf die Grundsätze stützt wie die vier Bedürfnisse Kompetenz, Eingebundenheit, Autonomie und Zweck. Diese Bedürfnisse sind beim Design Prozess einer Gamification Anwendung wichtig und müssen dementsprechend berücksichtigt werden.
\\\\
Die drei Game-Design Modelle wie Skill Atom-Modell, MDA-Modell und das CEGE-Modell wurden in diesem Kapitel aufgeführt um die Anforderungen des Design-Prozesses der bei einer Implementierung der gamifizierten Anwendung vorausgeht besser zu erfassen. 
\\\\
