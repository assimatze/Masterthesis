...
Die Artikel bzw. Seiten in Confluence sollen zusätzlich von den Lesern bewertet werden. Anhand von einfachen Abzeichen soll ein Player dem Autor bzw. Supporter mitteilen, ob der Eintrag für ihn \textit{hilfreich}, \textit{nicht hilfreich} oder \textit{nicht das war was der Player gesucht hat}. Diese Abzeichen sollen als Sammelgegenstände nicht nur dazu beitragen, dass die Player schneller und einfacher Feedback geben können. Sondern sie werden ebenfalls genutzt um den Fortschritt eines Autors zu tracken und über seine Art und Weise, Inhalte zu erzeugen. Dadurch würden wir sinnvoll die Mechanik Nummer zwei, das Sammeln aus der Liste der Spiele-Mechaniken verwenden.   
\\
\begin{figure}[h!]
\begin{center}
