...
\\\\
Die in dieser Arbeit ermittelten Erkenntnisse können nun auch dazu genutzt werden, den Ablauf eines Gamification-Projektes zu optimieren. Der größte Unterschied zwischen Gamification und anderen Ansätzen der Softwareentwicklung, wie beispielsweise dem \textit{User Experience Design}, ist die zentrale Rolle des Anwenders und dessen Zielen, die bei Gamification-Projekten hervorgehoben werden. Die Hauptaufgabe bei der Gestaltung eines Gamification-Projektes ist es, die Ziele des Anwenders zu identifizieren und nach Möglichkeiten zu suchen, ihn dabei zu unterstützen seine Ziele zu erreichen. In keinem uns bekannten Ansatz wird ein Anwender und dessen Anwenderziele so konsequent betrachtet wie bei der Gamification. Dieser Punkt kann nur durch ein ausgiebiges Verständnis über den Anwender erfüllt werden. Durch diese Aussage lassen sich auch die Probleme und Schwierigkeiten erklären, die in unsere Konzeptionsphase aufgetreten sind. Die von uns erhaltenen Informationen haben nicht dafür gesorgt, dass wir ein konkretes Verständnis für den Anwender entwickeln konnten. Hier wäre der verstärkte Einsatz von Personas und ein klares Verständnis über die Prozessabläufe von Confluence erforderlich gewesen. Dies wäre über einen ausführlicheren Fragebogen und über Anwenderinterviews möglich gewesen. Die zweite wichtige Aufgabe die Gamification erfüllen muss ist das Identifizieren der für den Anwender am sinnvollsten erscheinenden Spiele-Mechaniken. Diese müssen dem Anwender ein nach seinem Maßstäben geeignetes Erlebnis schaffen. Da aber jeder Anwender ein Individuum ist und seine eigenen Wertevorstellungen besitzt, kann dies nicht immer sauber und direkt erfolgen. In unserem Fall war die Vereinigung vieler Abhängigkeiten wie dem Anforderungen des Knowledge Managements und den Gamification Zielen erforderlich. Dabei gestaltete sich diese Aufarbeitung als umständlich und zeitintensiv. Die Vorgehensweise die für unser Konzept eingesetzt wurde, sollte also ebenfalls in zukünftigen Projekten optimiert werden. Um die Konzeptionsphase zu unterstützen, ist ein Framework erforderlich, dass die Identifizierung und die Umsetzung von Spiele-Mechaniken vereinfacht. Ein solches Framework gibt es bereits, es nennt sich \textit{Octalisys-Framework} und wurde von Yukai Chou, einem der führenden Gamification-Experten, entwickelt \cite{Octalisys}. Als Framework vereinigt Octalisys viele der Grundlagen, die wir im Kapitel \ref{Gamificationgrundlagen}, den Gamificationgrundlagen, behandelt haben. Dabei werden einige Aspekte der Gamification, wie z.B. die Grundsätze, über die von Yukai Chou eigens identifizierten \textit{Kerntriebe} (Core Drives) abgebildet. Diese Teilen sich in insgesamt acht Kerntriebe auf, die wir in ähnlicher Form auch in unseren Gamificationgrundlagen wiederfinden. Die acht Kerntriebe werden in Abbildung \ref{Kerntriebe} dargestellt.
\\
\begin{figure}[h!]
\begin{center}
\includegraphics[scale = 0.4]{Bilder/BildOctalisys.png}
\caption{Darstellung des Octalisys-Frameworks, und entsprechenden Beispielen \cite{Octalisys}}.
\label{Kerntriebe}
\end{center}
\end{figure} 
\\ 
Das Framework bietet also einen Überblick über die wichtigsten Antriebe von Menschen und kann also verwendet werden um ermitteln zu können, welche Mechaniken sich nutzen lassen um diese Antriebe anzusprechen. Durch die Abdeckung von allen Punkten oder zumindest einen großteil der Punkte, lassen sich laut Yukai Chou bindende Erlebnisse für den Anwender generieren. 
